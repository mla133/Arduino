...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x10, 0xA3, 0xA4 };//byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0xCC, 0xBA };
//IPAddress ip(192, 168, 181, 209); // IP address, may need to change depending on network (ip(10, 0, 0, 20);)
...
void setup()
{
  //using ethernet shielsd 2, not using SD card put pin 4 output and high
  pinMode(4, OUTPUT);
  digitalWrite(4, 1);
  Serial.begin(115200);
      ...
      { // client data available to read
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          { // HTTP request for web page
            ...
            client.println("<html>");
            client.println("<head>");
            client.println("<title>Meter 5-8 Control Web Page</title>");
            ...
            client.println("<h1>Meter Pulse Data (5-8)</h1>");
            ...
            //select list valve 1
            client.println("<td>");
            client.println("<p>Meter 5 Valve</p>");
            ...
            //select list Valve 2
            client.println("<td>");
            client.println("<p>Meter 6 Valve</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list Valve 3
            client.println("<td>");
            client.println("<p>Meter 7 Valve</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list Valve 4
            client.println("<td>");
            client.println("<p>Meter 8 Valve</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list meter 1
            client.println("<td>");
            client.println("<p>Meter 5 Pulse</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list meter 2
            client.println("<td>");
            client.println("<p>Meter 6 Pulse</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list meter 3
            client.println("<td>");
            client.println("<p>Meter 7 Pulse</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            //select list meter 4
            client.println("<td>");
            client.println("<p>Meter 8 Pulse</p>");
            client.println("<form action=\"\" method=\"get\">");
            ...
            client.println("<tr>");
            client.println("<td>");
            client.println("<p>Meter 5 Freq Adjust</p>");
            ...
            //start meter 2 slide
            client.println("<td>");
            client.println("<p>Meter 6 Freq Adjust</p>");
            client.println("0 Hz <input id=\"slide\" type=\"range\"");
            client.println("min=\"0\" max=\"1100\" step=\"8\" value=\"1100\"");
            ...
            //start meter 3 slide
            client.println("<td>");
            client.println("<p>Meter 7 Freq Adjust</p>");
            client.println("0 Hz <input id=\"slide\" type=\"range\"");
            client.println("min=\"0\" max=\"1100\" step=\"8\" value=\"1100\"");
            ...
            //start meter 4 slide
            client.println("<td>");
            client.println("<p>Meter 8 Freq Adjust</p>");
            client.println("0 Hz <input id=\"slide\" type=\"range\"");
            client.println("min=\"0\" max=\"1100\" step=\"8\" value=\"1100\"");
